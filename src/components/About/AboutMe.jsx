    ...
    <section className="w-full">
      ...
      <div className="flex flex-col md:flex-row w-full mb-20">
        <div className="md:w-1/2 h-1/2 md:h-auto p-12">
          <img src='https://firebasestorage.googleapis.com/v0/b/poplco.appspot.com/o/photos%2f42957488379-icon-1710472364561742672.jpg?alt=media' alt="About Us" className="object-cover w-full h-full" />
        </div>
